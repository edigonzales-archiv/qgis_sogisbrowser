...
class SogisBrowser:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'SogisBrowser_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&SO!GIS Browser')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'SogisBrowser')
        self.toolbar.setObjectName(u'SogisBrowser')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('SogisBrowser', message)
